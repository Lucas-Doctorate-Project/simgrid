...
XBT_PUBLIC void sg_host_set_carbon_embodied_footprint(const_sg_host_t host, double value);
...
XBT_PUBLIC void sg_host_set_water_embodied_footprint(const_sg_host_t host, double value);
